...
//regular
void rightComplexWP(void);
void rightMiddle(void);
void rightTriple(void);
void leftComplexWP(void);

//kickstand
void KICKrightComplexWP(void);
void KICKrightMiddle(void);
void KICKrightTriple(void);
void KICKleftComplexWP(void);


void leftMiddle(void);

//easy
void leftEasyWP(void);
void rightNeutral(void);
void soloWP(void);
